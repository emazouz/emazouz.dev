        ...
        <div className="w-full max-w-7xl px-4">
          <div data-aos="fade-out" className="text-center py-12 ">
            ...
            >
              ...
              for an affordable start, the Premium Plan to accelerate growth, or
              the Pro Plan for flexibility and advanced features. Powerful tools
              and reliable support make success within reach.
            </p>
          </div>
